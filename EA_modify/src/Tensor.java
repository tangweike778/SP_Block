...
public class Tensor {
    ...
    public Tensor(int mass, int[] size, int[][] attVals, double[][] spaceVals, int[] value, List<int[]> coreDimensionMass,  int[] timeSpaceMass, int[] latitudeMass, int[] longitudeMass,  boolean[] timeSpaceExisted, List<Map<Integer, List<Integer>>> selectDataByCoreDimension, Map<Integer, List<Integer>> selectDataByTimeSpace) {
        this.mass = mass;
        this.size = size;
